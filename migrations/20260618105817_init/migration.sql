...
-- AlterTable
ALTER TABLE `invoice` ADD COLUMN `installmentType` ENUM('Weekly', 'BiWeekly', 'Monthly', 'BiMonthly', 'Quarterly', 'BiQuarterly', 'HalfYearly', 'BiHalfYearly', 'Yearly', 'BiYearly', 'OneTime') NULL DEFAULT 'Monthly';

-- AlterTable
ALTER TABLE `loan` ADD COLUMN `loanInstallmentType` ENUM('Weekly', 'BiWeekly', 'Monthly', 'BiMonthly', 'Quarterly', 'BiQuarterly', 'HalfYearly', 'BiHalfYearly', 'Yearly', 'BiYearly', 'OneTime') NOT NULL DEFAULT 'Monthly';

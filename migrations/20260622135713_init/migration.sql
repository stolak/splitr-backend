...
CREATE TABLE `loan` (
    ...
    `loanInstallmentType` ENUM('Weekly', 'BiWeekly', 'Monthly', 'BiMonthly', 'Quarterly', 'BiQuarterly', 'HalfYearly', 'BiHalfYearly', 'Yearly', 'BiYearly', 'OneTime') NOT NULL DEFAULT 'Monthly',
...
CREATE TABLE `invoice` (
    ...
    `installmentType` ENUM('Weekly', 'BiWeekly', 'Monthly', 'BiMonthly', 'Quarterly', 'BiQuarterly', 'HalfYearly', 'BiHalfYearly', 'Yearly', 'BiYearly', 'OneTime') NULL DEFAULT 'Monthly',
    `createdAt` DATETIME(3) NOT NULL DEFAULT CURRENT_TIMESTAMP(3),
    `updatedAt` DATETIME(3) NOT NULL,
    `returnStatus` ENUM('Active', 'Approved', 'Rejected', 'Refunded', 'Pending') NULL DEFAULT 'Active',
    `returnAmount` DECIMAL(65, 30) NULL,
...
CREATE TABLE `persona_inquiry` (
    ...
    UNIQUE INDEX `persona_inquiry_inquiryId_key`(`inquiryId`),
    PRIMARY KEY (`id`)
) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
